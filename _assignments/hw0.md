...
4. File Transfer.  Unzip your website and copy the folder to your project directory: `cp -r projX/ /afs/andrew.cmu.edu/course/16/726-sp24/www/projects/andrew_id`.
   The folder structure should look like this:
    ```angular2html
    # suppose you are at /afs/andrew.cmu.edu/course/16/726-sp24/www/projects/andrew_id/
    index.html
    proj1/
        index.html
        data/...
